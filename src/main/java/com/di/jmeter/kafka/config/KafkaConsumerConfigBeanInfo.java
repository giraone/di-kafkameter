...
public class KafkaConsumerConfigBeanInfo extends BeanInfoSupport {
    ...
    public KafkaConsumerConfigBeanInfo() {
        ...
        //Connection configs
        createPropertyGroup("Kafka Connection Configs", new String[]{
            "kafkaBrokers",
            "groupId",
            "deSerializerKey",
            "deSerializerValue",
        ...
        //Security configs
        createPropertyGroup("Security", new String[]{
            SECURITY_TYPE,
            "kafkaSslTruststore",
            "kafkaSslTruststorePassword",
            "kafkaSslKeystore",
            "kafkaSslKeystorePassword",
            "kafkaSslPrivateKeyPass"
        });
        //Additional configs
        ...
        securityDescriptor.setValue(NOT_UNDEFINED, Boolean.TRUE);
        securityDescriptor.setValue(DEFAULT, "changeit");
